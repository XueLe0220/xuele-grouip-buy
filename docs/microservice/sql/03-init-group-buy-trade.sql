...
CREATE TABLE `group_buy_order` (
  ...
  `payable_amount` decimal(10,2) NOT NULL COMMENT '应付金额快照',
...
CREATE TABLE `group_buy_order_list` (
  ...
  `payment_request_no` varchar(64) DEFAULT NULL COMMENT '发起支付请求号',
  `payment_request_time` datetime DEFAULT NULL COMMENT '发起支付时间',
