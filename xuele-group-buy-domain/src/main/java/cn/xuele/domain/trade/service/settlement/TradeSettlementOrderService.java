...
public class TradeSettlementOrderService implements ITradeSettlementOrderService {
    ...
    public TradeSettlementEntity settlement(TradePaySettlementEntity tradePaySettlementEntity) throws Exception {
        ...
        log.info("拼团交易-结算开始 userId:{} outTradeNo:{}", tradePaySettlementEntity.getUserId(), tradePaySettlementEntity.getOutTradeNo());
        ...
        // 4. 调用基础设施层进行落库 (原子操作)
        repository.settlement(groupBuyTeamSettlementAggregate);
